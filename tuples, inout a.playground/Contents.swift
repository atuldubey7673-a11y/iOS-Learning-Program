...
func teamDetails(_ teamname:String="india",_ teamcaptain:String,_ homegound:String,_ score:Int){
    print("\(teamcaptain) is the captain of \(teamname) the ground of \(homegound) and the score was \(score)")
    
}
teamDetails("india", "virat", "mohali", 100)
